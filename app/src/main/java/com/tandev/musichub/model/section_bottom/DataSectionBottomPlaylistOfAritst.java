...
public class DataSectionBottomPlaylistOfAritst implements DataSectionBottom, Serializable {
    ...
    public Artists getSectionValue() {
        return sectionValue;
    }

    public void setSectionValue(Artists sectionValue) {
