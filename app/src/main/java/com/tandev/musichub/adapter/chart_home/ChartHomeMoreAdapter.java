...
public class ChartHomeMoreAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements PlayingStatusUpdater {
    ...
    public ChartHomeMoreAdapter(ArrayList<Items> songList, Activity activity, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_MORE) {
            ...
            return new ChartHomeMoreAdapter.MoreViewHolder(view);
        } else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bxh_song, parent, false);
            return new ChartHomeMoreAdapter.SongViewHolder(view);
        }
    }
