...
public class WeekChartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements PlayingStatusUpdater {
    private ArrayList<Items> songList;
    private final Context context;
    private final Activity activity;
    private int selectedPosition = -1;
    private int position_slider;
    ...
    public WeekChartAdapter(ArrayList<Items> songList, int position_slider, Activity activity, Context context) {
        this.songList = songList;
        this.position_slider = position_slider;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_MORE) {
            ...
            return new WeekChartAdapter.MoreViewHolder(view);
        } else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bxh_song, parent, false);
            return new WeekChartAdapter.SongViewHolder(view);
        }
    }
    ...
    public class MoreViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind() {
            btn_more.setOnClickListener(v -> {
                ...
                Bundle bundle = new Bundle();
                bundle.putSerializable("position_slide", position_slider);
