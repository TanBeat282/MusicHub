...
import com.tandev.musichub.adapter.artist.ArtistAllMoreAdapter;
...
public class ArtistSearchMultiFragment extends Fragment {
    ...
    private ArrayList<Artists> itemsArrayList = new ArrayList<>();
    private ArtistAllMoreAdapter artistAllMoreAdapter;
    ...
    public static ArtistSearchMultiFragment newInstance(String data) {
        ArtistSearchMultiFragment fragment = new ArtistSearchMultiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_artist_search_multi, container, false);
    }
    ...
    private void initAdapter() {
        ...
        artistAllMoreAdapter = new ArtistAllMoreAdapter(itemsArrayList, requireActivity(), requireContext());
        rv_search_song.setAdapter(artistAllMoreAdapter);
